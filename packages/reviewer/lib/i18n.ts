 ...
 * i18n configuration.
 *
 * Initialization is SYNCHRONOUS at import: the resources are bundled, so there
 * is nothing to await, and an async init from a layout effect is the shape that
