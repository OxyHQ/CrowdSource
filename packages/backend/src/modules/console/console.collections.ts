 ...
 *
 * Repository codecs whitelist fields explicitly so an unknown field is dropped rather
 ...
 * everything.
 */
export { CONSOLE_ROLES } from '../../domain/closedValues';
export type ConsoleRole = (typeof CONSOLE_ROLES)[number];

export { MEMBER_STATUSES } from '../../domain/closedValues';
...
export const organizationMembers = defineUnscopedCollection<OrganizationMemberDocument>(
  'OrganizationMember',
  {
 ...
 * them both.
 */
export { STAFF_ROLES } from '../../domain/closedValues';
...
export const trustSafetyStaff = defineUnscopedCollection<TrustSafetyStaffDocument>(
  'TrustSafetyStaff',
  {
