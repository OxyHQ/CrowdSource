...
const MUTATIONS = [
  {
    ...
    file: 'src/outbox/__tests__/support/webhookApp.ts',
    edits: [
      {
    ...
    test: 'src/outbox/__tests__/webhookRawBody.test.ts',
  ...
  },
  {
    ...
    test: 'src/outbox/__tests__/reviewOnlyApplication.test.ts',
  ...
  },
  {
    ...
    test: 'src/outbox/__tests__/fullLoop.test.ts',
  ...
  },
  {
    ...
    file: 'src/outbox/enforcement/planner.ts',
    edits: [
      {
    ...
    test: 'src/outbox/__tests__/enforcementReversal.test.ts',
  ...
  },
  {
    ...
    test: 'src/outbox/__tests__/configTypeErgonomics.test.ts',
  ...
  },
  {
    ...
    file: 'src/outbox/postgres/store/outbox.ts',
    edits: [
      {
...
`,
    ...
    test: 'src/outbox/__tests__/outboxTransactionCoupling.test.ts',
  ...
  },
  {
    ...
    file: 'src/outbox/postgres/store/enforcement.ts',
  ...
  },
  {
    ...
    test: 'src/outbox/__tests__/postgresOutboxStore.test.ts',
  ...
  },
  {
    ...
    file: 'src/outbox/postgres/store/events.ts',
    edits: [
      {
    ...
    test: 'src/outbox/__tests__/postgresEventStore.test.ts',
