 ...
 * `src/outbox/__tests__/support/postgres/migrations/` exists so this package's own suite
 ...
 * every `__tests__` directory beneath `src`, at any depth, and Task 13 asserts
 * that against the packed tarball. The glob itself is deliberately NOT written
 * out here — see the paragraph below.
 *
...
export default defineConfig({
  dialect: 'postgresql',
  schema: './src/outbox/__tests__/support/postgres/schema.ts',
  out: './src/outbox/__tests__/support/postgres/migrations',
